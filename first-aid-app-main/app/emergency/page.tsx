...
import { ArrowLeft, Phone, MapPin, Navigation, Video, MessageSquare } from "lucide-react"
import { Button } from "@/components/ui/button"
import MainNavigation from "@/components/main-navigation"

import ChatInterface from "@/components/chat-interface"
import LiveSupportCall from "@/components/live-support"
      ...
      <main className="flex-1">
        <section className="container px-4 py-6 max-w-6xl mx-auto">
          ...
          <div className="mt-10 border-t pt-8">
            <h2 className="mb-6 text-2xl font-bold text-center">Online Support Center</h2>
